...
public interface Writer<T> extends Serializable {
	 ...
	 *
	 * @param fs The {@link FileSystem} containing the newly opened file.
	 * @param path The {@link Path} of the newly opened file.
	 */
	void open(IFtpHandler ftpHandler, Path path) throws IOException;
	 ...
	 */
	void close(IFtpHandler ftpHandler) throws IOException;
