/**
* 修改flink源码中的该类去注册FlinkJobStatusListener
* */
...
//		schedulerNG.registerJobStatusListener(new FlinkJobStatusListener(jobGraph, jobManagerJobMetricGroup,
//				schedulerNG, this, this.getMainThreadExecutor()));
//
