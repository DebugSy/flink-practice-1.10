 ...
 *
 * COPY FROM {@link CsvRowSerializationSchema}
 * 将Flink DataStream Row转SQL Insert语句 "insert into table values ...",输出前后加括号
 */
public final class SnowballCsvRowSerializer implements Serializable{
	...
	private SnowballCsvRowSerializer(
	...
	/**
	 * A builder for creating a {@link SnowballCsvRowSerializer}.
	 */
	public static class Builder {
		...
		/**
		 * Creates a {@link SnowballCsvRowSerializer} expecting the given {@link TypeInformation}.
		 *
		...
		public SnowballCsvRowSerializer build() {
			return new SnowballCsvRowSerializer(
				typeInfo,
				csvSchema);
		}
	}
	...
	public boolean equals(Object o) {
		...
		final SnowballCsvRowSerializer that = (SnowballCsvRowSerializer) o;
