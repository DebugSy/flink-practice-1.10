...
public class RowToHoodieFunction<I extends Row, O extends HoodieRecord<?>>
   ...
   */
  private transient RowToAvroConverters.RowDataToAvroConverter converter;
  ...
  public RowToHoodieFunction(RowTypeInfo rowTypeInfo, Configuration config) {
  ...
  public void open(Configuration parameters) throws Exception {
    ...
    this.converter = RowToAvroConverters.createConverter(this.rowTypeInfo);
